            ...
            <SheetContent side="right" className="w-72">
              ...
              <nav className="flex flex-col gap-1 pt-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-3 inline-flex items-center justify-center gap-2 rounded-md bg-green-500 px-4 py-3 text-sm font-semibold text-white transition-all hover:bg-green-600"
                >
                  <MessageCircle className="size-4" />
                  WhatsApp Kami
                </a>
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <a href="https://www.instagram.com/alfi_official_sofa" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-red-400">
              ...
              <li>
                <a href="https://www.facebook.com/profile.php?id=61565219908785" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-red-400">
              ...
              <li>
                <a href="https://tiktok.com/@alfiofficialsofa" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-red-400">
